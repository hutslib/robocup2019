...
class where_is_this():
    ...
    def __init__(self, params):
        ...
        # 声明一些变量
        self.place = ["continue", "go on", "finish", "go out"]
    ...
    def analyze_content(self):
        ...
        self.TextToSpe.say("sorry, please say finish if you want me to leave the arena.")
    ...
    def start(self):
        ...
        self.go_to_waypoint(self.point_dataset["point20"], "point2", "first")


        #
        # self.go_to_waypoint(self.point_dataset["point51"], "point2", "first")
        # self.go_to_waypoint(self.point_dataset["point55"], "point2", "first")
        # self.go_to_waypoint(self.point_dataset["point34"], "point2", "first")
        # self.go_to_waypoint(self.point_dataset["point20"], "point2", "first")
        # 抬头
        self.angle = -.4
        ...
        while num != 1:
            ...
            self.TextToSpe.say("Dear operator, please say finish if you want me to leave the arena.")
            self.start_recording(reset=True)
            self.analyze_content()
            num += 1
        self.TextToSpe.say("ok, I will leave the arena")
        self.go_to_waypoint(self.point_dataset["point12"], "point2", "first")
        self.go_to_waypoint(self.point_dataset["point10"], "point2", "first")
        self.go_to_waypoint(self.point_dataset["point4"], "point2", "first")
        self.go_to_waypoint(self.point_dataset["point0"], "point2", "first")
