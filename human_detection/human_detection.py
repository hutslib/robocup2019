...
lib = CDLL("/home/hts/Pepper/RoboCup2019/object_detection/libdarknet.so", RTLD_GLOBAL)
...
class human_detector():
    def __init__(self):
        self.image_path = "/home/hts/Pepper/RoboCup2019/human_detection/data/human_detection.jpg"
        self.net = load_net("/home/hts/Pepper/RoboCup2019/human_detection/cfg/yolov3.cfg", "/home/fansa/Src/pepper_example/RoboCup2019/human_detection/weights/yolov3.weights", 0)
        self.meta = load_meta("/home/hts/Pepper/RoboCup2019/human_detection/data/voc.data")
