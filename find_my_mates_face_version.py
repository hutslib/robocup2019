...
class find_my_mate():
    ...
    def start(self):
        ...
        self.go_to_waypoint(self.point_dataset["point0"], "point0", "first")
        ...
        self.TextToSpe.say("Please give me a name")
        time.sleep(1)
        ...
        person_found_num = 0
        print "len of find person name", len(self.to_find_person_name)
        while person_found_num != len(self.to_find_person_name):
            print "continue______", len(self.to_find_person_name), person_found_num
            self.find_person()
            self.get_image_switch = True
            ...
            if self.dialog_with_people() == "succe":
                person_found_num += 1
                print "find dialog succe +1", person_found_num
        ...
        #     print "person_found_num", person_found_num
        #     self.find_person()
        #     self.get_image_switch = True
        #     self.amcl_pose_sb = rospy.Subscriber("/amcl_pose", PoseWithCovarianceStamped, self.amcl_pose_cb)
        #     self.show_image("instructions.png")
        ...
        #     if self.dialog_with_people() == "succe":
        #         person_found_num += 1
        #         print "person _found_num", person_found_num
        #         print dialog_with_people
        #         # 将当前人的信息传输到Pepper上
                ...
                if len(rects) != 0:
                    ...
                    if if_turn_finished:
                        ...
                        if (self.upper_wear == "none" and self.upper_color == "none"):
                            image_name = "/home/hts/RoboCup2019/person_body.jpg"
